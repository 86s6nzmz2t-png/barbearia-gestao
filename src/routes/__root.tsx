...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Barbearia — Gestão" },
      { name: "description", content: "App de gestão para barbearia: fluxo de caixa e controle de clientes." },
      { property: "og:title", content: "Barbearia — Gestão" },
      { property: "og:description", content: "App de gestão para barbearia: fluxo de caixa e controle de clientes." },
